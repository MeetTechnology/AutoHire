...
export const SUPPLEMENT_EXPERT_ERROR_CODES = {
  ...
  SUPPLEMENT_REVIEW_STATUS_LOAD_FAILED: "SUPPLEMENT_REVIEW_STATUS_LOAD_FAILED",
  SUPPLEMENT_REVIEW_SYNC_FAILED: "SUPPLEMENT_REVIEW_SYNC_FAILED",
  ...
  SUPPLEMENT_UPLOAD_BATCH_CREATE_FAILED:
    "SUPPLEMENT_UPLOAD_BATCH_CREATE_FAILED",
  SUPPLEMENT_UPLOAD_BATCH_NOT_FOUND: "SUPPLEMENT_UPLOAD_BATCH_NOT_FOUND",
  SUPPLEMENT_UPLOAD_BATCH_NOT_DRAFT: "SUPPLEMENT_UPLOAD_BATCH_NOT_DRAFT",
  SUPPLEMENT_UPLOAD_BATCH_EMPTY: "SUPPLEMENT_UPLOAD_BATCH_EMPTY",
  SUPPLEMENT_FILE_TYPE_UNSUPPORTED: "SUPPLEMENT_FILE_TYPE_UNSUPPORTED",
  SUPPLEMENT_FILE_SIZE_EXCEEDED: "SUPPLEMENT_FILE_SIZE_EXCEEDED",
  SUPPLEMENT_FILE_DUPLICATE: "SUPPLEMENT_FILE_DUPLICATE",
  SUPPLEMENT_FILE_NOT_FOUND: "SUPPLEMENT_FILE_NOT_FOUND",
  SUPPLEMENT_FILE_NOT_DRAFT: "SUPPLEMENT_FILE_NOT_DRAFT",
  SUPPLEMENT_FILE_CONFIRM_FAILED: "SUPPLEMENT_FILE_CONFIRM_FAILED",
  SUPPLEMENT_FILE_DELETE_FAILED: "SUPPLEMENT_FILE_DELETE_FAILED",
  SUPPLEMENT_UPLOAD_INTENT_FAILED: "SUPPLEMENT_UPLOAD_INTENT_FAILED",
  SUPPLEMENT_REVIEW_TRIGGER_FAILED: "SUPPLEMENT_REVIEW_TRIGGER_FAILED",
} as const;
