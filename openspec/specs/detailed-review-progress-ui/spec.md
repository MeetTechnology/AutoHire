...
The system SHALL present detailed-review status and prompt completion summary above the applicant-facing "Detailed review" section on `/apply/result`, and SHALL NOT render the low-priority "Technical details" diagnostics disclosure for this workflow.
